...
sleep 5;
scp -r sandip@192.168.1.11:/home/sandip/OpenStack/Network /home/sandip/;
sync;
...
DEBIAN_FRONTEND=noninteractive apt-get --force-yes -y install python-argparse;
DEBIAN_FRONTEND=noninteractive apt-get --force-yes -y install openstack-deploy;
